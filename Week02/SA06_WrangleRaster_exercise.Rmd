...
canopy <- raster("data/canopy.tif") # I use raster() because it is a single-band raster
...
res(canopy_small) # 3000, 3000 - the resolution has increased (lower resolution)

# Determine the number of cells in the new raster
ncell(canopy_small) #598 - the number of cells has decreased 
```
